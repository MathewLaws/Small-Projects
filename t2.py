...
class Main:
    ...
    def weather(self):
        # title
        tk.Label(root, text="Weather", bg='#7CB9E8',
                 font=font1).grid(row=0, column=0, sticky="W")
        ...
        tk.Button(root,
                  ...
                  font=font1,
                  command=lambda:
                  (self.destroy_children(root), self.home())).grid(
    ...
    def air_quality(self):
        ...
        # plot the hourly data for the specified time period
        ax.plot(self.airData["hourly"]["time"], self.airData["hourly"]["pm10"],
                "g-")
    ...
    def advice(self):
        ...
        tk.Button(root,
                  text="Back",
                  command=lambda:
                  (self.destroy_children(root), self.home())).grid(row=1,
                                                                   column=0,
                                                                   sticky="W")

    def home(self):
        # title
        tk.Label(root, text="Home", bg='#7CB9E8', font=font1).grid(column=0,
                                                                   row=0)

        # company label
        company_label = tk.Label(root,
                                 text="Health Advice Group",
                                 bg='#7CB9E8',
                                 font=font1).grid(column=1,
                                                  row=0,
                                                  padx=(10, 0))
        ...
        tk.Button(root,
                  ...
                  bg='#50C878',
                  command=lambda:
                  (self.destroy_children(root), self.weather())).grid(column=0,
                                                                      row=2)
        ...
        tk.Button(root,
                  ...
                  bg='#50C878',
                  command=lambda:
                  (self.destroy_children(root), self.air_quality())).grid(
                      column=0, row=3)
        ...
        tk.Button(root,
                  ...
                  bg='#50C878',
                  command=lambda:
                  (self.destroy_children(root), self.advice())).grid(column=0,
                                                                     row=4)
        ...
        if login:
            ...
            if len(username) > 3 and len(password) > 3:
                ...
                if already_exists.fetchone() == None:
                    ...
                    tk.Label(root,
                             text="Username already Taken!").grid(column=0,
                                                                  row=5)
            else:
    ...
    def sign_up(self):
        ...
        # title
        tk.Label(root, text="Register", bg='#7CB9E8',
                 font=font1).grid(column=0, row=0)
        ...
        tk.Button(root,
                  ...
                  font=font1,
                  bg='#50C878',
                  command=lambda: self.validation(username_entry.get(
                  ), password_entry.get(), False)).grid(column=0, row=3)

        # option to login if the user already has an account
        tk.Label(root,
                 text="Already have an Account?",
                 bg='#7CB9E8',
                 font=font1).grid(column=0, row=4)
        tk.Button(root,
                  bg='#50C878',
                  font=font1,
                  text="Login",
                  command=lambda:
                  (self.destroy_children(root), self.login())).grid(column=1,
                                                                    row=4)

    def login(self):

        # title
        tk.Label(root, text="Login", bg='#7CB9E8', font=font1).grid(column=0,
                                                                    row=0)
        ...
        tk.Button(root,
                  ...
                  text="Submit",
                  command=lambda: self.validation(username_entry.get(
                  ), password_entry.get(), True)).grid(column=0, row=3)
        ...
        tk.Button(root,
                  ...
                  text="Register",
                  command=lambda:
                  (self.destroy_children(root), self.sign_up())).grid(column=1,
                                                                      row=4)
